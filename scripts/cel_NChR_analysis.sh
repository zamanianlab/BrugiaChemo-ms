...
### ML tree inference 
cd "${cel_out}"
/home/BIOTECH/zamanian/install/standard-RAxML/raxmlHPC-PTHREADS-SSE3 -T 4 -f a -x 12345 -p 12345 -# 100 -m PROTGAMMAAUTO -s caenorhabditis_elegans_NCf_trim_filter.aln -n caenorhabditis_elegans_ML